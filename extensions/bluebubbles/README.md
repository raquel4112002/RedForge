...
This package contains the **BlueBubbles external channel plugin** for RedForge.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `RedForge/plugin-sdk` helpers.
