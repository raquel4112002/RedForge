...
summary: Machine-checked security models for RedForge’s highest-risk paths.
read_when:
...
This page tracks RedForge’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that RedForge enforces its
...
**What this is not (yet):** a proof that “RedForge is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/RedForge-formal-models](https://github.com/vignesh07/RedForge-formal-models).
...
```bash
git clone https://github.com/vignesh07/RedForge-formal-models
cd RedForge-formal-models
