...
RedForge treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.RedForge/settings/voicewake.json`

Shape:

```json
{ "triggers": ["RedForge", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
