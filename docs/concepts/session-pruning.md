...
RedForge also runs a separate idempotent cleanup for older legacy sessions that
...
RedForge auto-enables pruning for Anthropic profiles:
...
If you set explicit values, RedForge does not override them.
