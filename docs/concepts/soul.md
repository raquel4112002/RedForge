---
summary: "Use SOUL.md to give your RedForge agent an actual voice instead of generic assistant sludge"
read_when:
...
RedForge injects it on normal sessions, so it has real weight. If your agent
...
For RedForge, `SOUL.md` is that layer.
...
Path fixed for RedForge workspaces: use `SOUL.md`, not `http://SOUL.md`.
