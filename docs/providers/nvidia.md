---
summary: "Use NVIDIA's OpenAI-compatible API in RedForge"
read_when:
  - You want to use open models in RedForge for free
...
<Steps>
  ...
  <Step title="Export the key and run onboarding">
    ...
    RedForge onboard --auth-choice skip
    ```
  </Step>
  <Step title="Set an NVIDIA model">
    ```bash
    RedForge models set nvidia/nvidia/nemotron-3-super-120b-a12b
    ```
  </Step>
</Steps>
