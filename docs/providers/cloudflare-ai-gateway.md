...
read_when:
  - You want to use Cloudflare AI Gateway with RedForge
  - You need the account ID, gateway ID, or API key env var
---

# Cloudflare AI Gateway

Cloudflare AI Gateway sits in front of provider APIs and lets you add analytics, caching, and controls. For Anthropic, RedForge uses the Anthropic Messages API through your Gateway endpoint.
...
<Steps>
  <Step title="Set the provider API key and Gateway details">
    ...
    ```bash
    RedForge onboard --auth-choice cloudflare-ai-gateway-api-key
    ```
  ...
  <Step title="Verify the model is available">
    ```bash
    RedForge models list --provider cloudflare-ai-gateway
    ```
  </Step>
</Steps>
