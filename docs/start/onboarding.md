---
summary: "First-run setup flow for RedForge (macOS app)"
read_when:
...
- By default, RedForge is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give RedForge">
...
<Step title="CLI">
  ...
  The app can install the global `RedForge` CLI via npm, pnpm, or bun.
