---
summary: "Overview of RedForge onboarding options and flows"
read_when:
...
RedForge has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `RedForge onboard`                     | Launch the app            |
...
CLI command docs: [`RedForge onboard`](/cli/onboard)

## macOS app onboarding

Open the RedForge app. The first-run wizard walks you through the same steps
