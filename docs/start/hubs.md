---
summary: "Hubs that link to every RedForge doc"
read_when:
...
<Note>
If you are new to RedForge, start with [Getting Started](/start/getting-started).
</Note>
...
- [RedForge assistant](/start/RedForge)
