...
summary: "Testing utilities and patterns for RedForge plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for RedForge
plugins.
...
**Import:** `RedForge/plugin-sdk/testing`
...
} from "RedForge/plugin-sdk/testing";
```
...
import { installCommonResolveTargetErrorCases } from "RedForge/plugin-sdk/testing";
...
import type { PluginRuntime } from "RedForge/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `RedForge/plugin-sdk` root barrel is rejected
...
RedForge uses Vitest with V8 coverage thresholds. For plugin tests:
